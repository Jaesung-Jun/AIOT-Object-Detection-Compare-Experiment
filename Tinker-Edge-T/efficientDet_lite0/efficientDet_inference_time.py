...
parser = argparse.ArgumentParser(description="EfficientDet Test Code (Edited 2022-05-10)")
...
f = open(f"./efficientDet_inference_time.txt", "a")

f.write(f"{now_time}, {args.start_index}, {args.end_index}\n")
